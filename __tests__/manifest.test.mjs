...
describe("manifest.json", () => {
  ...
  // ── Cross-app contract ────────────────────────────────────────────────────
  it("reads the recipes export from the recipes app", () => {
    expect(manifest.data_access.reads).toContain("app.recipes.recipes");
  });
  ...
  it("does not declare exports (family-meals consumes but does not share data)", () => {
    expect(manifest.exports ?? null).toBeNull();
  });
});
